#!/usr/bin/env python3
"""
Simple Extended Ensemble Evaluation:
- Detection models (Mistral-7B LoRA) - only working ones
...
DETECT_MODELS = {
    ...
    # Skip r_detect_transfer due to tokenizer incompatibility
}
...
def main():
    print("="*70)
    print("EXTENDED ENSEMBLE EVALUATION (Simple)")
    print("="*70)
